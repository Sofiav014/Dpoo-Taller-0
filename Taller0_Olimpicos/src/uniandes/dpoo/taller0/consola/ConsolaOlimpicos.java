...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				if (opcion_seleccionada == 1)
					...
					ejecutarPaisRepresentanteAtleta();
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais representante de un atleta");
	...
	private void ejecutarPaisRepresentanteAtleta()
	{
		...
		{
			System.out.println("\n" + "El pais representante del atleta " + nombre_atleta + " es " + pais);
		}
	}
