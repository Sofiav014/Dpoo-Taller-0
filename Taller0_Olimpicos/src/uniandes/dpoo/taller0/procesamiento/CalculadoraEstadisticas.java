...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Busca el pais representante del atleta indicado por parametro
	 * @param nombre_atleta
	 * @return un string con el nombre del pais representante del atleta indicado por parametro
	 * 			
	 * 		   Si el nombre no corresponde al de ningún atleta, retorna null.
	 */
	public String PaisRepresentanteAtleta (String nombre_atleta)
	{
		Atleta elAtleta = buscarAtleta(nombre_atleta);
		if (elAtleta == null)
		{
			return null;
		}
		else
		{
			...
			String resultado = pais.darNombre();
			return resultado;
		}
	}
